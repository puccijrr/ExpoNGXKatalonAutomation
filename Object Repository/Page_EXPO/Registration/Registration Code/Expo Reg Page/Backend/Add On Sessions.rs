...
<WebServiceRequestEntity>
   ...
   <name>Add On Sessions</name>
   <tag></tag>
   <elementGuidId>1cb266cc-fec8-4183-a93d-3731f84b385f</elementGuidId>
   ...
   <restUrl>${url}/api/${webVersion}/forms/631/registration_levels/${regLevelID}/addon_sessions/</restUrl>
