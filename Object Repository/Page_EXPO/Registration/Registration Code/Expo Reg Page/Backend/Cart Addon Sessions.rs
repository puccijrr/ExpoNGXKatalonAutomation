...
<WebServiceRequestEntity>
   ...
   <name>Cart Addon Sessions</name>
   <tag></tag>
   <elementGuidId>4c2675d9-51f7-46d2-a541-3aafc2e83acf</elementGuidId>
   ...
   <restUrl>${url}/api/${webVersion}/forms/631/registration_levels/${regLevelID}/sessions/</restUrl>
