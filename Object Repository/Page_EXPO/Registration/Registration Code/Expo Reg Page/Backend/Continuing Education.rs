...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>a65ae29f-3704-4f4d-9829-e71975a0b68f</elementGuidId>
   ...
   <restUrl>${url}/api/${webVersion}/forms/${eventID}/registration_levels/${regLevelID}/educations/</restUrl>
