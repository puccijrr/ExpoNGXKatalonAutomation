...
<WebServiceRequestEntity>
   ...
   <name>GetPrivPolicy</name>
   <tag></tag>
   <elementGuidId>aebaa3fe-2de4-4db3-bad4-45e7744714f8</elementGuidId>
   ...
   <restUrl>${url}/api/${webVersion}/legal/terms/privacy_policy/file/</restUrl>
...
//Check html body start
assertThat(response.getResponseText()).contains('PRIVACY POLICY LAST UPDATED')</verificationScript>
