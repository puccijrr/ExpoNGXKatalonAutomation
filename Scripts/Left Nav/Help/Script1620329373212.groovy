...
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/li_Help')) //Click Help button that should open url in new tab
...
//Verify url in new tab is for Attendee Help Center (regardless of user)
check_link()
...
def check_link() {
    ...
    if (url_check == GlobalVariable.helpCenterAttendeeURL) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the Help nav button in a new tab')
