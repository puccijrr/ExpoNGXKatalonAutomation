...
//Verify url goes to My Schedule page
check_link()
...
//Verify "My Schedule" View option is selected (active) on Sessions List
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Session List/View/Active (Selected)/li_My Schedule'), 5)
