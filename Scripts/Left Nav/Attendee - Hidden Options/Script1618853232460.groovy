...
//Verify expected attendee hidden items are NOT seen
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/li_Sponsorships'), 2, FailureHandling.CONTINUE_ON_FAILURE) //Verify Sponsorships options is NOT Present
