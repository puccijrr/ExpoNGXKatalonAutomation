...
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/li_Home'))

WebUI.delay(2)

//Verify url is still on events home
check_link()

//Verify Event header is found (otherwise test will fail here)
...
def check_link() {
    ...
    if (url_check == GlobalVariable.eventHomeURL) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the Home nav button')
