...
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_My Events'))

WebUI.delay(2)

//Verify navs back to events list url
check_link()
...
def check_link() {
    ...
    if (url_check == GlobalVariable.events) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the My Events button')
