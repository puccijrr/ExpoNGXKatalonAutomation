...
WebUI.setText(findTestObject('Object Repository/Page_EXPO/Login Objects/input_Email Address_ngx'), GlobalVariable.loginSensitive)
...
def check_login() {
    ...
    if (url_check == GlobalVariable.events) {
        ...
        KeywordUtil.markFailed('FAIL: Login may have become case sensitive!!')
