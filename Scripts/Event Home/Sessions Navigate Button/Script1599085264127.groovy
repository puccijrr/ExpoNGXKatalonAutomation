...
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_navigate_next')) //Click Session Navigate button

WebUI.delay(2)

//Verify url goes to Sessions page
check_link()
...
//Verify "Event Schedule" View option is selected (active) on Sessions List
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Session List/View/Active (Selected)/li_Event Schedule'), 5)
...
def check_link() {
    ...
    if (url_check == GlobalVariable.scheduleURL) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the session navigate button')
