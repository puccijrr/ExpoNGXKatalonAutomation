...
//Select Admin Menu then click Registration
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_Admin Menu keyboard_arrow_down'))
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/Admin Menu Items/li_Registration'))
...
//Verify opens the right legacy page which includes "legacy/events/[eventID]/registration" and PASS, otherwise fail with message
check_link()
...
def check_link() {
    ...
    if (url_check == GlobalVariable.legacyRegistration) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the Registration Admin Menu item in a new tab')

        log.logInfo(url_check)
    } else {
        KeywordUtil.markFailed('FAIL: incorrect url found, or new tab didnt open!!')
