...
//Select Admin Menu then click Sponsorships
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_Admin Menu keyboard_arrow_down'))
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/Admin Menu Items/li_Sponsorships'))
WebUI.delay(5)
...
WebUI.verifyElementPresent(findTestObject('Page_EXPO/Sponsorships/h1_Sponsor Bundles'), 5)
