...
//Select Admin Menu then click Sessions
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_Admin Menu keyboard_arrow_down'))
WebUI.click(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/Admin Menu Items/li_Sessions'))
...
//Verify opens the right legacy page which includes "legacy/events/[eventID]/sessions" and PASS, otherwise fail with message
check_link()
...
def check_link() {
    ...
    if (url_check == GlobalVariable.legacySessions) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the Sessions Admin Menu item in a new tab')
