...
//Navigate to URL to Events List on NGX
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Events List NGX/search_input'), 3)
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Events List NGX/label_Upcoming Events'), 3)
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Events List NGX/label_Past Events'), 3)
