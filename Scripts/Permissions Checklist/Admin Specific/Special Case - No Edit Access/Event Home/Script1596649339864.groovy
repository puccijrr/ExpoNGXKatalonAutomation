...
//Admin Toolbar (Not Visable for admins WITHOUT edit access)
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Page_EXPO/Events Main page/NGX Home/button_Edit'), 3) //Edit Mode Buton
