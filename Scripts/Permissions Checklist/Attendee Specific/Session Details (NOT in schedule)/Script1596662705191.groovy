...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Session Details/button_Add'), 3) //Add Button (Should be shown since session should NOT be in attendee schedule)
