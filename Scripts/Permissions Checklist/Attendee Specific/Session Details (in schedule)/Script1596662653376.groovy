...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Session Details/h4_My Schedule'), 3) //My Schedule Label
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_EXPO/Session Details/button_Remove'), 3) //Remove Button (Should be shown since session should be in attendee schedule)
