...
//Select the pane's Enter icon
WebUI.click(findTestObject('Page_EXPO/Events List NGX/Event Specific/Automation/a_Enter keyboard_arrow_right'))

//Verify enters the right home page which includes "/events/[conf_id]" and PASS, otherwise fail with message
WebUI.delay(3)
...
def check_link() {
    ...
    if (url_check == GlobalVariable.eventHomeURL) {
        KeywordUtil.markPassed('PASS: the correct URL was found after clicking the Enter> icon')
