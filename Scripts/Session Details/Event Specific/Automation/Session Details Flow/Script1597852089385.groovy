...
//Verify Session Details header is found (otherwise test will fail here)
WebUI.verifyElementPresent(findTestObject('Page_EXPO/Session Details/Headers/h1_Auto Test Session'), 5)
